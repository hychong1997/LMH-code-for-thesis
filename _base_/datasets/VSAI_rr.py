...
#     train=dict(
#         type=dataset_type,
#         ann_file=[data_root + 'train/annfiles/', data_root + 'test/annfiles/'],
#         img_prefix=[data_root + 'train/images/', data_root + 'test/images/'],
...
#     test=dict(
#         type=dataset_type,
#         ann_file=data_root + 'test_all/images/',
#         img_prefix=data_root + 'test_all/images/',
#         pipeline=test_pipeline))
