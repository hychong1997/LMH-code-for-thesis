...
class VSAIDataset_resizewithf(VSAIDataset):
    def __init__(self,
                 pipeline,
                 multi_scales=[(1200, 1200), (400, 400)],
                 use_random_ms=False,
                 **kwargs):
        super(VSAIDataset_resizewithf, self).__init__(pipeline=pipeline, **kwargs)
    ...
    def load_annotations(self, ann_folder):   # ann_folder=ann_file
        ...
        distance_path = os.path.join(ann_folder, 'distance_f')
