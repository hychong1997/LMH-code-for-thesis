...
data = dict(
    ...
    test=dict(
        # ann_file=data_root + 'pitch/test/-30_0/annfiles/',
        # img_prefix=data_root + 'pitch/test/-30_0/images/',
        # ann_file=data_root + 'pitch/test/-60_-30/annfiles/',
        # img_prefix=data_root + 'pitch/test/-60_-30/images/',
        ann_file=data_root + 'pitch/test/-90_-60/annfiles/',
        img_prefix=data_root + 'pitch/test/-90_-60/images/'
))